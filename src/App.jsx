...
function App() {
  ...
  return (
    <div className="relative overflow-x-hidden">
      <NavigationBar />
      <section id="home">
        <div className="grid grid-cols-[1.2fr_1fr] mt-[30px] sm:mt-[20px] sm:grid-cols-2 sm:grid-rows-[1fr_1.1fr] md:grid-cols-[1.3fr_1fr] md:grid-rows-[1fr_1.2fr] lg:h-[100vh] lg:mt-[30px]">
